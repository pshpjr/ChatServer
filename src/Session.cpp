...
bool Session::recvHandleWaitInGroup()
{
	return _isHandled.load(std::memory_order::acquire);
}

void Session::setRecvHandled(bool value)
{
	_isHandled.store(value, std::memory_order::release);
}
