...
public:
    ...
    explicit SharedLockGuard(SRWLOCK& lock)
        : _cs(lock)
    {
...
public:
    ...
    explicit ExclusiveLockGuard(SRWLOCK& lock)
        : _cs(lock)
    {
...
public:
    ...
    explicit ReadLockGuard(std::shared_mutex& lock)
        : _cs(lock)
    {
        _cs.lock_shared();
    }
...
public:
    ...
    explicit WriteLockGuard(std::shared_mutex& lock)
        : _cs(lock)
    {
        _cs.lock();
    }
